...
public class Main {
	...
	// write your code here
        ...
        ncSearchTree.add(0,"b");
        ncSearchTree.add(-1,"b");
        ncSearchTree.add(5,"a");
        //ncSearchTree.add(16,"a");
        ncSearchTree.add(8,"c");
        ncSearchTree.add(6,"c");
        ncSearchTree.add(9,"c");
